export default {
  ...
  'pages.forgotPassword.subtitle': 'Enter your email to reset your password',
  'pages.forgotPassword.sendResetLink': 'Send Reset Link',
  'pages.resetPassword.subtitle': 'Enter your new password below',
  'pages.resetPassword.submit': 'Reset Password',
  'pages.resetPassword.password.placeholder': 'New Password',
  'pages.resetPassword.password.required': 'Please input your new password!',
  'pages.resetPassword.confirmPassword.placeholder': 'Confirm Password',
  'pages.resetPassword.confirmPassword.required': 'Please confirm your password!',
